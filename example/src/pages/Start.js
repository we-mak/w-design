...
const Start = () => {
  return (
    <div>
      ...
      <CodeBlock
        language="bash"
        exampleCode={`npm install --save w-design styled-components
# or
yarn add w-design`}
      />
      ...
      <CodeBlock
        exampleCode={`import { Provider, Container } from "w-design";
...
>
  <App/>
      ...
      <p>For example:</p>
      <CodeBlock exampleCode={`<Container bg="N2">...</Container>`} />
    </div>
  );
};
