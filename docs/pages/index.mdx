...
W-design UI toolkit is a monorepo and manage with:

- [Lerna](https://lerna.js.org/) to manage monorepo packages.
- Typescript to manage react props
- Babel for manage bundling packages
