...
const AvatarPage = () => {
  return (
    <>
      ...
      <Avatar m={1} size="xxl" avatarUrl="https://api.adorable.io/avatars/240/thunder" />
      <Avatar m={1} size="xl" avatarUrl="https://api.adorable.io/avatars/180/hammer" />
      <Avatar m={1} size="lg" avatarUrl="https://api.adorable.io/avatars/120/ginger" />
      <Avatar m={1} size="md" avatarUrl="https://api.adorable.io/avatars/120/sharp" />
      <Avatar m={1} size="sm" avatarUrl="https://api.adorable.io/avatars/80/vn" />
      <Avatar m={1} size="xs" avatarUrl="https://api.adorable.io/avatars/60/kr" />
      <p />
      <Typo appearance="h4">Data init</Typo>
      Initial data from user name if there is no avatar image. Background color is random auto
      generate from theme colors.
